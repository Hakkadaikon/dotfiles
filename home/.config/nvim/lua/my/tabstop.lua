...
local tabstop_settings = {
  ...
  h = { tabstop = 2, shiftwidth = 2, expandtab = true },
  cpp = { tabstop = 2, shiftwidth = 2, expandtab = true },
  hpp = { tabstop = 2, shiftwidth = 2, expandtab = true },
  cxx = { tabstop = 2, shiftwidth = 2, expandtab = true },
  hxx = { tabstop = 2, shiftwidth = 2, expandtab = true },
  ixx = { tabstop = 2, shiftwidth = 2, expandtab = true },
  cc = { tabstop = 2, shiftwidth = 2, expandtab = true },
  hh = { tabstop = 2, shiftwidth = 2, expandtab = true },
