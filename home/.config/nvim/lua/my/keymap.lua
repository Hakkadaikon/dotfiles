...
function mykeymap.setup()
  ...
  mapset.n("gj")({ desc = "LSP go to type definition", vim.lsp.buf.type_definition })
  ...
  mapset.i("tn")({ desc = "New tab", ":<ESC>tabnew<CR>" })
  mapset.n("ts")({ desc = "Split tab", ":vsplit<CR>" })
  mapset.i("ts")({ desc = "Split tab", ":<ESC>vsplit<CR>" })
  mapset.n("tv")({ desc = "Vsplit tab", ":split<CR>" })
  mapset.i("tv")({ desc = "Vsplit tab", ":<ESC>vsplit<CR>" })
  mapset.n("td")({ desc = "Close pain", ":close<CR>" })
  mapset.i("td")({ desc = "Close pain", ":<ESC>close<CR>" })
end
